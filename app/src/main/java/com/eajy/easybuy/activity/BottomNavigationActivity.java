...
import com.eajy.easybuy.view.BottomNavigationViewHelper;
...
public class BottomNavigationActivity extends AppCompatActivity {
    ...
    private ViewPager.OnPageChangeListener pageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            ...
            int evaluate = getResources().getColor(R.color.app_white);
            if (position == 0) {
                evaluate = (Integer) evaluator.evaluate(positionOffset, getResources().getColor(R.color.app_white), getResources().getColor(R.color.app_green));
            } else if (position == 1) {
